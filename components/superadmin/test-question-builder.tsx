...
export function TestQuestionBuilder() {
      ...
      questions.map((q) => {
        if (q.id === questionId) {
          ...
          return {
            ...
            options: [
              ...q.options,
              { id: newOptionId, text: `Option ${q.options.length + 1}` },
            ],
          };
        }
        return q;
  ...
  // Modernize the appearance of options by enhancing their layout and styling
  const OptionItem = ({
    option,
    index,
    onRemove,
  ...
  // Update the rendering of options to use the new OptionItem component
  const renderOptions = (options: Option[], onRemove: (id: string) => void) => (
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Create and manage the questions for your test
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateQuestionType(currentQuestion.id, value as QuestionType)
                }
              >
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  updateQuestionRequired(currentQuestion.id, !!checked)
                }
              />
            ...
            {currentQuestion.type !== "open-ended" && (
              <div className="space-y-2">
                ...
                {renderOptions(currentQuestion.options, (id) =>
                  deleteOption(currentQuestion.id, id)
                )}
              </div>
            )}
          </CardContent>

export const enneagramTest = {
  ...
  questions: [
    ...
    {
      id: 1,
      text: "I am too strict with myself and others.",
      type: "A",
      options: [
        { value: "1", label: "No" },
    ...
    {
      id: 3,
      text: "I am more organized than most.",
      type: "A",
      options: [
        { value: "1", label: "No" },
        { value: "2", label: "Partly" },
    ...
    {
      id: 4,
      text: "I am more formal than most people.",
      type: "A",
      options: [
        { value: "1", label: "No" },
        { value: "2", label: "Partly" },
    ...
    {
      id: 7,
      text: "I hold a tight rein on my temper.",
      type: "A",
      options: [
        { value: "1", label: "No" },
        { value: "2", label: "Partly" },
    ...
    {
      id: 8,
      text: "I can't rest until the job is done.",
      type: "A",
      options: [
        { value: "1", label: "No" },
        { value: "2", label: "Partly" },
    ...
    {
      id: 11,
      text: "I seldom compromise my principles.",
      type: "A",
      options: [
        { value: "1", label: "No" },
        { value: "2", label: "Partly" },
    ...
    {
      id: 16,
      text: "I am more loving than most people.",
      type: "B",
      options: [
        { value: "1", label: "No" },
        { value: "2", label: "Partly" },
    ...
    {
      id: 19,
      text: "No one would ever call me selfish!",
      type: "B",
      options: [
        { value: "1", label: "No" },
        { value: "2", label: "Partly" },
    ...
    {
      id: 24,
      text: "I'm good at motivating people.",
      type: "B",
      options: [
        { value: "1", label: "No" },
        { value: "2", label: "Partly" },
    ...
    {
      id: 32,
      text: "I am good at getting things done.",
      type: "C",
      options: [
        { value: "1", label: "No" },
        { value: "2", label: "Partly" },
    ...
    {
      id: 35,
      text: "I'll do what it takes to be successful.",
      type: "C",
      options: [
        { value: "1", label: "No" },
        { value: "2", label: "Partly" },
    ...
    {
      id: 38,
      text: "I am highly individualistic.",
      type: "D",
      options: [
        { value: "1", label: "No" },
        { value: "2", label: "Partly" },
    ...
    {
      id: 45,
      text: "I am more dramatic than most.",
      type: "D",
      options: [
        { value: "1", label: "No" },
        { value: "2", label: "Partly" },

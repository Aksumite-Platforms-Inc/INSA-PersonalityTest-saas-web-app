...
import { ArrowLeft, Mail, Phone, Calendar, Building, Briefcase, Clock } from "lucide-react"
...
export default function EmployeeDetailsPage({ params }: { params: { orgId: string; id: string } }) {
  ...
  // Find the employee
  const employees = employeesByOrganization[organizationId as keyof typeof employeesByOrganization] || []
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm">Last active {new Date(employee.lastActive).toLocaleDateString()}</span>
              </div>
            </div>
            ...
            <div className="pt-4 border-t">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-muted-foreground">{employee.testsCompleted} tests completed</span>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <TabsContent value="personality" className="space-y-4 mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Based on completed personality assessments</CardDescription>
                </CardHeader>
            ...
            <TabsContent value="tests" className="space-y-4 mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>History of completed assessments</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
            ...
            <TabsContent value="documents" className="space-y-4 mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Documents shared with this employee</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">No documents have been shared with this employee yet.</p>
                </CardContent>
              </Card>
            </TabsContent>
          </Tabs>
